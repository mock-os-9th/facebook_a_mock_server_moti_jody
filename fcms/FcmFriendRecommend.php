...
foreach ($res as $key => $item){
    $item['recommendUserIdxName'] = json_decode($item['recommendUserIdxName'],true);
    echo $item['recommendUserIdxName'][0]['recommendUserIdx'];
...
//    curl_close($ch);
//
//    addFriendNotification(intval($item['userIdx']),intval($item['recommendUserIdxName']['recommendUserIdx']),$message);
//
